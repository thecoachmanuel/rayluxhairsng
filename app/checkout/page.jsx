...
const CheckoutPage = () => {
  ...
  if (authLoading || (!authUser && typeof window !== "undefined")) {
    return (
      <>
        <Navbar />
        <div className="min-h-[50vh] flex items-center justify-center pt-20 md:pt-24">
  ...
  return (
    <>
      <Navbar />
      <div className="px-6 md:px-16 lg:px-32 pt-20 md:pt-24 mb-20 flex flex-col items-center">
