...
const Cart = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-20 md:pt-24 mb-20">
				...
				{Object.keys(cartItems).map((itemId) => {
                  ...
                  return (
                    <tr key={itemId}>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">₦{(product.offerPrice * cartItems[itemId]).toFixed(0)}</td>
                    </tr>
                  );
                })}
              </tbody>
